...
//     let value = grid[m][n] + grid[0][0];
//     // перевірка де менше число чи справа чи знизу
//     // додаємо до value значення цього числа
//     // продовжуємо цикл
//     while (m > 0 && n > 0) {
...
console.log(minPathSum([2,2],[1,0])); // 3
console.log(minPathSum([[1,2,0],[5,4,2],[1,1,3]])); // 8
